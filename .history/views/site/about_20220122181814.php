...
<?php
$query = new Query();
    $query->select('id_b','price')->from('cakes.cake')->innerJoin('cakes.base','cakes.cake.id_b = cakes.base.id_b',array('cakes.cake.id_b => cakes.base.id_b'))->where(array('name' => 'coffe base'));
