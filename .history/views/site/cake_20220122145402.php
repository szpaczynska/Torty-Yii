...
<div class="site-cake">
    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <?= $form->field($model, 'id_a')-> dropDownList(ArrayHelper::map(Addition::find()->all(),'id_a','name'), ['prompt'=>'Choose ...']);  ?>        <?= $form->field($model, 'name')->textInput() ?>
        <?= $form->field($model, 'descrption')->textInput() ?>
