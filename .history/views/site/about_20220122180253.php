...
<?php
$query = new Query();
    $query->select('price')->from('cakes.base')->leftjoin('cakes.cake','cakes.base.id_b= cake.id_b',array('base.id_b'=>'cake.id_b'))->where(array('cakes.base.id_b'=>'cakes.cake.id_b'));
