...
<?php
$query = new Query();
    $query->select('price')->from('cakes.base')->innerJoin('cakes.cake','cakes.base.id_b = cakes.cake.id_b',array('cakes.base.id_b => cakes.cake.id_b'))->where(array('name' => 'coffe base'));
